...
export default class Accountant extends Component<Props> {
  constructor(props) {
    super(props);
  ...
  const ViewMore = <Text style={styles.ServicesMore} > {services.length - 5} more ..</Text>
  ...
  const placeholder = <Text></Text>
    ...
    return (
      ...
      {services.length > 5 ? ViewMore :  placeholder}
       ...
       <TouchableOpacity
         style={styles.button}
         onPress={()=>{this.props.navigate.navigate('Profile',{'aid':this.props.aid})}}>
