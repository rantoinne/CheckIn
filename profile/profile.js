...
type Props = {};
export default class AccProfile extends Component<Props> {
  constructor(props){
    super(props);
    this.state={}
  ...
  body: JSON.stringify({"aid" : this.props.navigation.state.params.aid}),
   ...
   render () {
    ...
    <ScrollView>
    <Image source={require('../images/default.png')} style = {styles.logo}/>
    ...
    <Text style={styles.accountantAddress}> 
        ...
        <Text style={styles.accountantAddress}><Entypo  name='mail' size={16} color =  'black' />  - {this.state.email2}</Text></View>) : (null)
        }
  ...
  <Text style={{marginTop : 20 , marginBottom : 5 ,fontSize : 20 , fontWeight : 'bold'}}> Client Reviews </Text>
